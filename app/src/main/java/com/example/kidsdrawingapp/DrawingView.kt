...
//            20.toFloat() // Here the default or we can initial brush/ stroke size is defined.
    ...
    override fun onDraw(canvas: Canvas) {
         ...
         * @param top The position of the top side of the bitmap being dra
    ...
    {
//        to ensure that different screen size wil have differnent brush size appro[prately because if we will set a particluar size then it will be thick in one scree and thin in another
